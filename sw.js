const CACHE_NAME = "hc-gitpages-pwa-v9-viewer-counter";
const SHELL_FILES = [
  "./",
  "./assets/app-viewer-counter.css?v=20260518-viewer-counter",
  "./assets/app-viewer-counter.js?v=20260518-viewer-counter",
  "./assets/logo.svg",
